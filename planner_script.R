...
for (i in 48:1) {
  if (nchar(i) == 1) {
    cat(paste0(
      "w0", i, "_tel_date  & w0", i, "_tel_comp  ~ \"w0", i, "_tel\",\n"
    ))
  } else {
    cat(paste0(
      "w", i, "_tel_date  & w", i, "_tel_comp  ~ \"w", i, "_tel\",\n"
    ))
  }
}
...
# stage_completed == "w01_tel"  ~ "w02_tel",

for (i in 1:47) {
  if (i < 9) {
    cat(paste0(
      "stage_completed == \"w0", i, "_tel\"  ~ \"w0", i+1, "_tel\",\n"
    ))
  } else if (i == 9) {
    cat(paste0(
      "stage_completed == \"w0", i, "_tel\"  ~ \"w", i+1, "_tel\",\n"
    ))
  } else {
    cat(paste0(
      "stage_completed == \"w", i, "_tel\"  ~ \"w", i+1, "_tel\",\n"
    ))
  }
}
